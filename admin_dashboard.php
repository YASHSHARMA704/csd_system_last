...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['submit'])) {
        ...
        if (!empty($_FILES['item_image']['name'])) {
            ...
            $sql = "UPDATE items SET itemId='$new_itemId', name='$name', category='$category', description='$description', price='$price', stock_quantity='$stock_quantity', Remarks = '$remarks', Unit = '$unit', limitt = '$limit', limit1 = '$limit1', item_image='$item_image' , date_and_time_added= CURRENT_TIMESTAMP WHERE itemId='$itemId'";
        } else {
            $sql = "UPDATE items SET itemId='$new_itemId', name='$name', category='$category', description='$description', price='$price' , limitt = '$limit', limit1 = '$limit1', stock_quantity='$stock_quantity', Remarks = '$remarks', Unit = '$unit' , date_and_time_added =CURRENT_TIMESTAMP WHERE itemId='$itemId'";
        }
...
<head>
    ...
    <style>
        ...
        .welcome-message {
            ...
            margin-bottom: 6px;
            margin-left: 180px; /* Added margin bottom for spacing */
            font-weight: bold;
        }
        .temp3
        {
        ...
        /* Style for description and image cells (optional) */
        #myTable .description {
            max-width: 200px;
            overflow: hidden;
...
<body>
    ...
    <div class="welcome-message temp3">Welcome, ADMIN</div>
    ...
    <div class="container">
        ...
        <div class="table-container">
            <table id="myTable">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM items ORDER BY date_and_time_added desc";
