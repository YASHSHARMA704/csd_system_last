...
body {
  ...
  margin: 0;
  padding: 0;
   /* background: linear-gradient(#ffb6c1, #fffacd); */
   /* background: linear-gradient(to right, #f093fb, #f5576c); */
   /* background: linear-gradient(to right, #ff9a9e, #fad0c4, #fad0c4); */
   background: linear-gradient(to right, #c471f5, #fa71cd, #fa71cd);
...
.container {
  ...
  margin-top:100px;
  height: 60%;
  /* background-color: palegoldenrod; Add a semi-transparent background */
  background: linear-gradient(to right, #add8e6, #ffb6c1);
